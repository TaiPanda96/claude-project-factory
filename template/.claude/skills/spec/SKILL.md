...
description: >
  ...
  scratch-pad thinking into a high-fidelity spec file in docs/superpowers/specs/.
...
**You write NO code. You produce one file: a high-fidelity spec in `docs/superpowers/specs/`.**
...
```bash
cat docs/superpowers/specs/SPEC_CONVENTIONS.md
cat docs/superpowers/specs/TEMPLATE.md
```

If the repo has domain-specific templates (`docs/superpowers/specs/backend/TEMPLATE.md`, `docs/superpowers/specs/frontend/TEMPLATE.md`), pick the one that matches the feature. These define the required output format. Every section in the chosen TEMPLATE must appear in your output.
...
Write the spec to `docs/superpowers/specs/spec-NNN-[title-slug].md`.
...
1. **Spec written:** `docs/superpowers/specs/spec-NNN-[slug].md`
...
5. **Next step:** `/plan docs/superpowers/specs/spec-NNN-[slug].md` — or "resolve open questions first"
